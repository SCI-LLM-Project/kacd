...
def query_kg_causal_lit_prompt(question, var1, var2, report, definitions, debug=False):
    system = (
        ...
        "\n--- INSTRUCTIONS ---\n"
        "Use the relevant information in the report, as well as the definitions given, as context to help you answer the following question.\n"
        ...
        "\n--- OUTPUT STRUCTURE ---\n"
        f"Based on your reasoning, output {OUTPUT_FORMAT} as your final conclusion. Output your reasoning and conclusion explicitly in valid JSON. You must adhere to the specific format defined by this Pydantic Model:\n"
f"""
...
def query_llm_causal_lit_prompt(question, var1, var2, definitions, debug=False):
    ...
    system = (
        "\n--- ROLE ---\n"
        f"You are an expert in the field of chronic pain, health care, and medicine. Given the multiple choice question, output {OUTPUT_FORMAT}.\n"
        "Failure to follow directions will result in immediate termination.\n"
        "\n--- INSTRUCTIONS ---\n"
